...
describe('Cache Service', () => {
    ...
    describe('createCacheService', () => {
        ...
        it('should prevent cache store creation when cache handler is not a valid object', () => {
            ...
            const createCacheServiceWithOnlyGetCacheHandler =
                () => cacheService.createCacheService(onlyGetHandler)

            expect(createCacheServiceWithOnlyGetCacheHandler)
            ...
            expect(createCacheServiceWithGetAndUpsertCacheHandler)
                .to.throw(SyntaxError)

            const getUpsertRemoveHandler =
                { get: () => {}, upsert: () => {}, remove: () => {} }

            expect(cacheService.createCacheService(getUpsertRemoveHandler))
                .to.be.a('object')
